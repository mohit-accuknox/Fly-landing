  ...
  return (
    <div>
      <section className="flex justify-between items-center p-7 font-semibold ">
        ...
        <ul className={isActive ? "flex items-start gap-10 lg:absolute lg:top-24 lg:bg-gray-700 transition-all sm:hidden lg:p-10 lg:-left-1/2 lg:flex-col lg:w-6/12 lg:items-center sm:w-full": "flex items-start gap-10 lg:absolute lg:top-24 lg:bg-gray-700 lg:p-10 transition-all lg:-left-2 lg:flex-col lg:w-6/12 lg:items-center sm:w-full"}>
          <li>
            <a
              href="#"
        ...
        <img src={isActive ? "images/menu.png" : "images/cross.png"} alt="" className="hidden lg:block" onClick={() => setIsActive(!isActive)}/>
